...
<section class="hero-area container">
    <div class="hero-post-slides owl-carousel">
        ...
        <div class="single-hero-post d-flex flex-wrap">
            ...
            <!-- Post Content -->
            <div class="slide-post-content d-flex align-items-center" style="background-color: #222222;">
                <div class="slide-post-text">

                    <p class="post-excerpt text-white" data-animation="fadeIn" data-delay="500ms">'.$news['Content'].'</p>
