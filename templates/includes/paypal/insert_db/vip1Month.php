...
$vip1Month = $db->prepare("INSERT INTO meh_users_payments (user_id,Username,Purchase,Purchase_id,Fecha) VALUES ($user_id, '$name','Vip 1 Month', 2, CURRENT_TIMESTAMP)");
$vip1Month->execute();


$expira = date("Y-m-d H:i:s", strtotime("+1 month"));
$add_gold = $old_gold + 100000;
$add_coins = $old_coin + 100000;
$add_donation = $old_donations + 5;

$vip1Month = $db->prepare("UPDATE meh_users SET Purchase='Vip 1 Month', Purchase_id=2, UpgradeExpire='$expira',UpgradeDays=1, Gold='$add_gold', Coins='$add_coins', Access=10, Donations='$add_donation' WHERE id=$user_id");
$vip1Month->execute();
