  ...
  <body>
    ...
    <div>
      <div class="full">
        ...
        <h6 class="heading-hr"><i class="icon-file"></i> Insert news</h6>
                </ul>
          </div>
    ...
    <div>
      ...
      <div class="full">
        <div class="block-title">
        <h6 class="heading-hr"><i class="icon-file"></i> Search News</h6>
                </ul>
                </div>
      ...
      if(!(isset($_POST['search-term']))){
        ...
        $sql = "SELECT COUNT(*) AS total FROM `meh_news`";
        ...
        $sql = "SELECT * FROM `meh_news` ORDER BY `id` DESC LIMIT ".$inicio.", ".$_BS['bypage'];
        $query = $db->prepare($sql);
        $query ->execute();
        ...
        foreach ($resultado as $row) {
          ...
          echo "
            <tr>
              ...
              <td>$name</td>
              <td>
              <a href='add-news.php?edit=$id'><i class='fa fa-pencil-square-o text-info'></i></a>
              </td>
            </tr>
          ";
        }
        ...
        $busca_it = $db->prepare("SELECT * FROM meh_news WHERE ((`Title` LIKE '%".$busca_prot."%') OR ('%".$busca_prot."%'))");
        $busca_it ->execute();
