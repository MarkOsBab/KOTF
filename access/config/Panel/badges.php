...
<html>
  <head>
    <Name>Restricted access - KOTF</Name>
  ...
  <body>
    ...
    <div>
      <div class="full">
        ...
        <h6 class="heading-hr"><i class="icon-file"></i> Insert Badge</h6>
                </ul>
          </div>
        <form action="add-badges.php" method="POST">
          <div class="input-group">
            <input type="text" id="search-term" name="add-term" class="form-control" placeholder="Badge name">
    ...
    <div>
      ...
      <div class="full">
        <div class="block-Name">
        <h6 class="heading-hr"><i class="icon-file"></i> Search Badge</h6>
                </ul>
                </div>
        <form action="" method="post">
          <div class="input-group">
            <input type="text" id="search-term" name="search-term" class="form-control" placeholder="Badge name">
            <span class="input-group-btn">
              <button type="submit" class="btn btn-default"><i class="fa fa-search text-info"></i></button>
            </span>
          </div>
                ...
                <hr>
                <div class="Name"><strong>News</strong></div>
      ...
      if(!(isset($_POST['search-term']))){
        ...
        $sql = "SELECT COUNT(*) AS total FROM `meh_achievements`";
        ...
        $sql = "SELECT * FROM `meh_achievements` ORDER BY `id` DESC LIMIT ".$inicio.", ".$_BS['bypage'];
        $query = $db->prepare($sql);
        $query ->execute();
        ...
        foreach ($resultado as $row) {
          ...
          echo "
            <tr>
              ...
              <td>$name</td>
              <td>
              <a href='add-badges.php?edit=$id'><i class='fa fa-pencil-square-o text-info'></i></a>
              </td>
            </tr>
          ";
        }
        ...
        $busca_it = $db->prepare("SELECT * FROM meh_achievements WHERE ((`Name` LIKE '%".$busca_prot."%') OR ('%".$busca_prot."%'))");
        $busca_it ->execute();
