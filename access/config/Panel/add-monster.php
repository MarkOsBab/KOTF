      ...
      <div class="block full">
        ...
        <?php
          if(isset($_POST['add'])){
            ...
            $respawnTime = addslashes($_POST['respawnTime']);
            ...
            if(empty($id) || empty($nome)){
              ...
              $insert_item_db = $db->prepare("INSERT INTO meh_monsters (`id`, `Name`, `MonColorName`, `Race`, `FileName`, `HP`, `MP`, `Level`, `Gold`, `Exp`, `Rep`, `Drops`, `DPS`, `Element`, `Linkage`, `React`, `PvpScore`, `TeamID`, `Skills`, `Coins`, `points`, `respawnTime`) VALUES ($id, '$nome', '0', 'None', '$FileName', '$HP', '$MP', '$Level', '$Gold', '$Exp', '$Rep', '$Drops', '$DPS', 'None', '$Linkage', '50', '50', '0', '0', '0', '0', '$respawnTime')");
...
<table>
          <tr>
            ...
            <td class="pt-3 pl-3">
              <font>Monster respawn time:</font>
              <select name="respawnTime" class="form-control mb-3 mb-3 bg-dark">

                <?php if(isset($_POST['respawnTime']) && $_POST['respawnTime'] >= 0){ ?>
      ...
      <div class="block full">
        ...
        <?php
          if(isset($_POST['edd'])){
            ...
            $ed_respawnTime = addslashes($_POST['ed_respawnTime']);

            if(empty($ed_name) || empty($ed_FileName)){
              echo "<b>Fill out all fields!</b>";
            }else{
              $insert_db = $db->prepare("UPDATE meh_monsters SET Name='$ed_name', MonColorName='0', Race='None', FileName='$ed_FileName', HP='$ed_HP', MP='$ed_MP', Level='$ed_Level', Gold='$ed_Gold', Exp='$ed_Exp', Rep='$ed_Rep', Drops='$ed_Drops', DPS='$ed_DPS', Element='None', Linkage='$ed_Linkage', React=' 50', PvpScore='50', TeamID='0', Skills='0', Coins='0', points='0', respawnTime='$ed_respawnTime' WHERE id='$ed_id'");
              $insert_db->execute();
              if($insert_db){
...
setTimeout(function () { location.href = 'monsters.php';
        ...
        <?php
          ...
          if($conta_edit > 0){
            ...
            $edit_respawnTime = $fetch_edit['respawnTime'];
}
        ?>
          <form action="" method="POST">
            <table>
              ...
              <td class="pt-3 pl-3">
              <font>Monster respawn time:</font>
              <select name="ed_respawnTime" class="form-control mb-3 mb-3 bg-dark">

                <?php if($edit_respawnTime == 5){ ?>
                  <option selected value="5">5 Seconds</option>
                  <option value="3">3 Seconds</option>
                  <option value="6">6 Seconds</option>
                  <option value="7">7 Seconds</option>
                  ...
                  <option value="55">55 Seconds</option>
                  <option value="60">60 Seconds</option>
                <?php } if ($edit_respawnTime == 3) { ?>
                  <option value="5">5 Seconds</option>
                  <option selected value="3">3 Seconds</option>
                  <option value="6">6 Seconds</option>
                  <option value="7">7 Seconds</option>
                  <option value="8">8 Seconds</option>
                  <option value="9">9 Seconds</option>
                  ...
                  <option value="60">60 Seconds</option>
                <?php } ?>
                <?php if ($edit_respawnTime == 6) { ?>
                  <option value="5">5 Seconds</option>
                  <option value="3">3 Seconds</option>
                  <option selected value="6">6 Seconds</option>
                  <option value="7">7 Seconds</option>
                  <option value="8">8 Seconds</option>
                  <option value="9">9 Seconds</option>
                  <option value="10">10 Seconds</option>
                  ...
                  <option value="60">60 Seconds</option>
                <?php } ?>
              <?php if ($edit_respawnTime == 7) { ?>
                  <option value="5">5 Seconds</option>
                  <option value="3">3 Seconds</option>
                  <option  value="6">6 Seconds</option>
                  <option selected value="7">7 Seconds</option>
                  <option value="8">8 Seconds</option>
                  <option value="9">9 Seconds</option>
                  <option value="10">10 Seconds</option>
                  <option value="15">15 Seconds</option>
                  ...
                  <option value="60">60 Seconds</option>
                <?php } ?>
              <?php if ($edit_respawnTime == 8) { ?>
                  <option value="5">5 Seconds</option>
                  <option value="3">3 Seconds</option>
                  <option  value="6">6 Seconds</option>
                  <option  value="7">7 Seconds</option>
                  <option selected value="8">8 Seconds</option>
                  <option value="9">9 Seconds</option>
                  <option value="10">10 Seconds</option>
                  <option value="15">15 Seconds</option>
                  <option value="20">20 Seconds</option>
                  ...
                  <option value="60">60 Seconds</option>
                <?php } ?>
                <?php if ($edit_respawnTime == 9) { ?>
                  <option value="5">5 Seconds</option>
                  <option value="3">3 Seconds</option>
                  <option  value="6">6 Seconds</option>
                  <option  value="7">7 Seconds</option>
                  <option  value="8">8 Seconds</option>
                  <option selected value="9">9 Seconds</option>
                  <option value="10">10 Seconds</option>
                  <option value="15">15 Seconds</option>
                  <option value="20">20 Seconds</option>
                  <option value="25">25 Seconds</option>
                ...
                <?php if ($edit_respawnTime == 25) { ?>
                  ...
                  <option  value="15">15 Seconds</option>
                  <option  value="20">20 Seconds</option>
                  <option selected value="25">25 Seconds</option>
                  <option value="30">30 Seconds</option>
                  <option value="35">35 Seconds</option>
                  <option value="40">40 Seconds</option>
                  <option value="45">45 Seconds</option>
                ...
                <?php if ($edit_respawnTime == 35) { ?>
                  ...
                  <option  value="25">25 Seconds</option>
                  <option  value="30">30 Seconds</option>
                  <option selected value="35">35 Seconds</option>
                  <option value="40">40 Seconds</option>
                  <option value="45">45 Seconds</option>
                  <option value="50">50 Seconds</option>
                  <option value="55">55 Seconds</option>
                ...
                <?php if ($edit_respawnTime == 40) { ?>
                  ...
                  <option  value="30">30 Seconds</option>
                  <option  value="35">35 Seconds</option>
                  <option selected value="40">40 Seconds</option>
                  <option value="45">45 Seconds</option>
                  <option value="50">50 Seconds</option>
                  <option value="55">55 Seconds</option>
                  <option value="60">60 Seconds</option>
                <?php } ?>
                <?php if ($edit_respawnTime == 45) { ?>
                  <option value="5">5 Seconds</option>
                  <option value="3">3 Seconds</option>
                  <option  value="6">6 Seconds</option>
                  <option  value="7">7 Seconds</option>
                  ...
                  <option  value="35">35 Seconds</option>
                  <option  value="40">40 Seconds</option>
                  <option selected value="45">45 Seconds</option>
                  <option value="50">50 Seconds</option>
                  <option value="55">55 Seconds</option>
                  <option value="60">60 Seconds</option>
                <?php } ?>
                <?php if ($edit_respawnTime == 50) { ?>
                  <option value="5">5 Seconds</option>
                  <option value="3">3 Seconds</option>
                  <option  value="6">6 Seconds</option>
                  <option  value="7">7 Seconds</option>
                  ...
                  <option  value="40">40 Seconds</option>
                  <option  value="45">45 Seconds</option>
                  <option selected value="50">50 Seconds</option>
                  <option value="55">55 Seconds</option>
                  <option value="60">60 Seconds</option>
                <?php } ?>
                <?php if ($edit_respawnTime == 55) { ?>
                  <option value="5">5 Seconds</option>
                  <option value="3">3 Seconds</option>
                  <option  value="6">6 Seconds</option>
                  <option  value="7">7 Seconds</option>
                  ...
                  <option  value="45">45 Seconds</option>
                  <option  value="50">50 Seconds</option>
                  <option selected value="55">55 Seconds</option>
                  <option value="60">60 Seconds</option>
                <?php } ?>
                <?php if ($edit_respawnTime == 60) { ?>
                  <option value="5">5 Seconds</option>
                  <option value="3">3 Seconds</option>
                  <option  value="6">6 Seconds</option>
                  <option  value="7">7 Seconds</option>
                  ...
                  <option  value="50">50 Seconds</option>
                  <option  value="55">55 Seconds</option>
                  <option selected value="60">60 Seconds</option>
                <?php } ?>
              </select>
            </td>
              </tr>
