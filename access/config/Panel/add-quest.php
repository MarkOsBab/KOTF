...
<?php }else if(!(empty($passon))){ ?><?php } else { ?>
<!DOCTYPE html>
<html>
  <head> 
    <meta charset="utf-8">
        ...
        <?php
          ...
          if(isset($_POST['edd'])){
            ...
            if(empty($ed_name)){
              ...
              $insert_db = $db->prepare("UPDATE meh_quests SET sName='$ed_name', iLvl='$ed_iLvl', factionID='1', iWar='0', iClass='0', iReqRep='0', iValue='0', iSlot='-1', iCoins='0', iRep='0', turnin='$ed_turnin', sEndText='$ed_sEndText', bUpg='$ed_bUpg', iReqCP='0', iExp='$ed_iExp', sAuthor='$useron', sDifficult='$ed_sDifficult', rewType='$ed_rewtype', oRewards='$ed_oRewards', bOnce='0', sDesc='$ed_sDesc', cValue='0', cSlot='0', iCP='0', iIndex='0', sField='', IsOnce='0', sFaction='1', iBadgerID='0', iGold='$ed_iGold' WHERE id='$ed_id'");
                $insert_db->execute();
